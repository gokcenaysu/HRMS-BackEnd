...
public class messages {
    ...
    public static String deleted="The user has been deleted";
    ...
    public static String passwordFormat="Please create a password consisting of upper and lower case letters, numbers and signs";
    public static String birthYearFormat="Please enter your birth year";
    public static String errorPassword="Wrong password";
    public static String existsPosition="This position already exists";
    public static String noData="This data not exists ";
